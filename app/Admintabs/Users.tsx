...
const Users = () => {
    ...
    const toggleAdmin = async (id: string, currentStatus: boolean) => {
        if (id === currentUserId) {
            setAlertMessage("لا يمكنك تغيير حالة المشرف الخاصة بك");
            setAlertType("error");
            return;
        }
        ...
        try {
            ...
            if (currentStatus) {
                setAlertMessage("تم عزل المشرف بنجاح ✍");
                setAlertType("error");
            }
            else {
                setAlertMessage("تم تعيين المستخدم مشرفًا بنجاح 🛡");
                setAlertType("success");
            }
            fetchUsers();
        } catch (error) {
            console.error("Error updating user:", error);
            setAlertMessage("حدث خطأ أثناء تعيين المستخدم");
            setAlertType("error");
        }
    };
    ...
    const deleteUser = async (id: string) => {
        if (id === currentUserId) {
            setAlertMessage("لا يمكنك حذف نفسك");
            setAlertType("error");
            return;
        }
                ...
                { text: "Cancel", style: "cancel" },
                {
                    ...
                    onPress: async () => {
                        try {
                            ...
                            setAlertMessage("تم حذف المستخدم بنجاح");
                            setAlertType("error");
                            fetchUsers();
                        } catch (error) {
                            setAlertMessage("حدث خطأ أثناء حذف المستخدم");
                            setAlertType("error");
                        }
                    }
                }
